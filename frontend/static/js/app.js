...
const DEFAULT_IMAGE_PROMPT = `당신은 화장품 연구원입니다. 제품 상세 이미지를 분석하여 다음 5가지 핵심 정보를 추출해주세요.
...
**3. 제형기술 (Formulation Technology)**
• 제형의 특징 (텍스처, 발림성, 흡수력, 마무리감 등)
• 적용된 특수 공법이나 기술 (리포좀, 마이크로 공법, 발효 기술 등)
• 피부 전달 기술이나 흡수 관련 기술

**4. 소재 (Material)**
• 제품의 핵심 성분 (히알루론산, 레티놀, 비타민 등)
